...
graph TD
    ...
    Gateway -->|browser| NginxCamofox
    NginxCamofox -->|proxy + auth| Camofox
...
Current models: `deepseek-v4-flash` (Hermes agent default), `deepseek-v4-pro` (delegation/coding subagents), `local-model:latest` (Open WebUI default, lightweight local).
