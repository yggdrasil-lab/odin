...
*   **Authentication (LLDAP):** Integrated with the `cerberus_lldap` service (port `3890`) on the shared `aether-net` network, enabling centralized user authentication.
...
| `LLDAP_LDAP_USER_PASS` | The password of your LLDAP admin bind account | `your_secure_password` |
